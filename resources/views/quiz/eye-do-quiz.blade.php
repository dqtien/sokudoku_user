...
@section('page-css')
    <link rel="stylesheet" href="{!! asset('quiz-eye.css') !!}">
@stop
...
@section('content')
    <div class="content">
        <div class="quiz-content">
            <div class="intro">
                <img style="margin-bottom: 30px" src="{!! asset('assets/images/home/eye.png') !!}" alt="Introduce image !!!">
        ...
        <div class="quiz-bar">
            <div class="type-logo">
                <img src="{!! asset('assets/images/quiz/eye-logo.png') !!}" alt="Eye Excercise!">
            </div>
...
@section('page-script')
    ...
    <script src="{!! asset('assets/js/page/quiz-eye.js') !!}"></script>
